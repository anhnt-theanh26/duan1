...
{
    $sql = "SELECT hoadon.id as iddh, chitiethoadon.id, sanpham.id as idsp, sanpham.iddm as iddm, sanpham.ten_san_pham, hoadon.trang_thai, hoadon.ngay_dat, chitiethoadon.so_luong, hoadon.ten_kh, hoadon.dia_chi, hoadon.sdt, hoadon.email, chitiethoadon.don_gia, chitiethoadon.thanh_tien 
    FROM chitiethoadon 
