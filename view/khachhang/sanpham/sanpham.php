        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="intro-section slider-height-1 slider-content-center bg-img single-animation-wrap slider-bg-color-1"
                    style="background-image:url(view/assets/images/slider/slider-bg-1.jpg)">
                    <div class="container">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="hero-slider-img-1 slider-animated-1">
                                    <img class="animated animated-slider-img-1"
                                        src="view/assets/images/slider/slider-bg-10.jpg" alt="">
                                    <!-- <div class="product-offer animated">
                                                <h5>30% <span>Off</span></h5>
                                            </div> -->
                                </div>
        ...
        <div class="section-title-tab-wrap mb-75">
            ...
            if (isset($_GET['id']) && ($_GET['id'])) {
                ...
                <form action="" method="post">
                    <select name="timkiem" id="" style="width: 200px;">
                                ...
                                <div class="product-img img-zoom mb-25">
                                    ...
                                    <form action="index.php?act=addcart" method="post">
                                        <div class="product-action-2-wrap">
                                            ...
                                            <input type="submit" name="addtocart" class="product-action-btn-2"
                                                title="Add To Cart" value="Thêm vào giỏ hàng">
                                        </div>
                                    </form>
                                </div>
